...
public class Crawler {
	 ...
	 * @throws MalformedURLException
	 */
	public String getHtml(String wurl, String zfState) throws MalformedURLException{
		String temp = null;
		URL url = new URL(wurl);
		StringBuffer sb = new StringBuffer();
		try {
			BufferedReader input = new BufferedReader(new InputStreamReader(url.openStream(),zfState));
			while((temp=input.readLine()) != null ){
				sb.append(temp);
			}
			//System.out.println(sb.toString());
...
//		String url = "http://list.tmall.com/search_product.htm?spm=a221t.7038233.1996090305.13.c1AJki&cat=50025145&style=g&search_condition=71&from=sn_1_cat&active=1&tab=mall";
		//String aa = craw.clientGetHtml(url);
//		String aa = craw.getHtml(url);
